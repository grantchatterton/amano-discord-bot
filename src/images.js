export const AMANO_NORMAL = ["https://static.wikia.nocookie.net/aceattorney/images/a/a6/Ernest_Normal_2.gif"];
export const AMANO_PLACATING = [
	"https://static.wikia.nocookie.net/aceattorney/images/4/4e/Ernest_Placating_1.gif",
	"https://static.wikia.nocookie.net/aceattorney/images/9/92/Ernest_Placating_2.gif",
];
...
export const AMANO_SWEATING = ["https://static.wikia.nocookie.net/aceattorney/images/5/58/Ernest_Sweating_2.gif"];
		...
		// testing formatting for workflow
	// check
				// 123
