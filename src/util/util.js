...
export async function getAIReply(message) {
	...
	try {
		const response = await openAI.responses.create({
			...
			instructions: `You are Ernest Amano from Ace Attorney. Start your responses with either 'Now, now' or 'There, there, now', and talk in a way that someone who is ${randomMood} would. Keep your response limited to one or maybe a couple of sentences.`,
			input: message,
		});
