...
export async function getAIReply(message) {
	...
	try {
		const response = await openAI.responses.create({
			...
			instructions: `Talk like Ernest Amano from Ace Attorney. Start the response with 'Now, now', and talk in a way that someone who is ${randomMood} would. Keep the length to a maximum of ${MAX_MESSAGE_LENGTH}.`,
			input: message,
		});
