...
// export const AMANO_NOW_NOW_QUOTES = AMANO_QUOTES.filter((quote) => {
// 	const quoteLower = quote.toLowerCase();
// 	return quoteLower.includes('now, now') || quoteLower.includes('there, there');
// });

export const AMANO_NOW_NOW_QUOTES = JSON.parse(fs.readFileSync(path.join(appRoot.path, 'quotes.json')));
